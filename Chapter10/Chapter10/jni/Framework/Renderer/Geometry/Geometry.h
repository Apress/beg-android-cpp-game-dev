...
namespace Framework
{
	...
	public:
		...
		int					GetNumNormalPositionElements() const	{ return m_numNormalPositionElements; }
	...
	inline void Geometry::SetNumNormalPositionElements(const int numNormalPositionElements)
	{
